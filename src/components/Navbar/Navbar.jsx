 ...
 const handleNav=()=>{
  ...
  return (
    <div className='text-primeColor font-bold flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4'>
        <h1 className='w-full text-2xl  tracking-[5px] font-bold  text-primeColor'>eCommerce</h1>
        <ul className='hidden md:flex '>
          <li className='p-4 font-light hover:text-[#000000] transition duration-500  cursor-pointer'>Home</li>
          <li className='p-4 font-light hover:text-[#00df9a] transition duration-500  cursor-pointer'>About</li>
          <li className='p-4 font-light hover:text-[#00df9a] transition duration-500  cursor-pointer'>Contact</li>
